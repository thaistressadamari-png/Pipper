    ...
    <footer className="bg-white mt-4 py-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center text-brand-text">
        ...
        <div className="mt-6 text-sm text-gray-500">
          <p>&copy; <button onClick={() => onNavigate('login')} className="bg-transparent p-0 m-0 focus:outline-none focus:ring-0 appearance-none font-sans text-sm text-gray-500">{currentYear}</button> Pipper Confeitaria. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
